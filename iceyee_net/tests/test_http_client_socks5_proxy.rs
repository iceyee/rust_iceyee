...
pub async fn test_httpclient_socks5_proxy() {
    println!("");
    let proxy = Socks5Proxy::new("112.124.30.170", 10002, Some("iceyee:74591870")).wrap();
    ...
    let url: &str = "https://buff.163.com/api/market/goods/sell_order?_=1749054468649&allow_tradable_cooldown=1&appid=730&from_refresh=1&goods_id=42961&page_num=1&page_size=24";
